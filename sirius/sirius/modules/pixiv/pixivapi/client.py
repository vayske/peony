...
from .common import HEADERS, format_bool, parse_qs, require_auth
from .enums import ContentType, RankingMode, SearchTarget, Sort, Visibility
from .errors import BadApiResponse, LoginError
from .models import Account, Comment, FullUser, Illustration, Novel, User
...
class Client:
    ...
    def __init__(
        ...
        self.session = CloudflareScraper()
        self.session.headers.update(HEADERS)

        if self.language:  # pragma: no cover
            self.session.headers.update({"Accept-Language": self.language})

    async def _request_json(self, method, url, params=None, headers=None, data=None):
        """
    ...
    async def download(self, url, destination, referer="https://pixiv.net"):
        """
        ...
        """
        async with self.session.get(url=url, headers={"Referer": referer}) as response:
    ...
    async def _make_auth_request(self, data):
        client_time = (
            datetime.utcnow()
    ...
    @require_auth
    async def fetch_illustration(self, illustration_id):
        """
    ...
    @require_auth
    async def fetch_illustration_comments(
    ...
    @require_auth
    async def fetch_illustration_related(self, illustration_id, offset=None):
        """
    ...
    @require_auth
    async def fetch_illustrations_following(self, visibility=Visibility.PUBLIC, offset=None):
        """
    ...
    @require_auth
    async def fetch_illustrations_recommended(
        self,
    ...
    @require_auth
    async def fetch_illustrations_ranking(self, mode=RankingMode.DAY, date=None, offset=None):
        """
    ...
    @require_auth
    async def fetch_bookmark(self, illustration_id):
        """
    ...
    @require_auth
    async def delete_bookmark(self, illustration_id):  # pragma: no cover
        """
        Delete a bookmark.
    ...
    @require_auth
    async def fetch_user_illustrations(
        self,
        user_id,
        content_type=ContentType.ILLUSTRATION,
        offset=None,
    ...
    @require_auth
    async def fetch_user_bookmarks(
        self,
        user_id,
        visibility=Visibility.PUBLIC,
    ...
    @require_auth
    async def fetch_user_bookmark_tags(
        self,
        user_id,
        visibility=Visibility.PUBLIC,
        offset=None,
    ...
    @require_auth
    async def fetch_following(self, user_id, visibility=Visibility.PUBLIC, offset=None):
        """
    ...
    @require_auth
    async def fetch_followers(self, offset=None):
        """
